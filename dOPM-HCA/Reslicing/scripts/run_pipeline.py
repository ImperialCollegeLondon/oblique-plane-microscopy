...
def main():
    ...
    # --- WORKFLOW STEP 3: Process the Sample Data ---
    print("\n--- Starting Step 3: Sample Data Conversion with Registration ---")
    sample_converter = DataConverter(config['data'])
    sample_converter.process_well_with_registration(
        well=well_to_process,
        bead_xml_path=bead_xml_path
    )
    print("--- Sample Data Conversion Complete ---")
