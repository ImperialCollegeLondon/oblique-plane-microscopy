...
class BdvBase:
    ...
    def read_affine_list(self, time=0, illumination=0, channel=0, tile=0, angle=0):
        """" Read affine matrix list of a view from the XML file.
        ...
        Returns:
        --------
            list of Numpy (3,4) float arrays, the transformation matrices.
            """
        self._get_xml_root()
        isetup = self._determine_setup_id(illumination, channel, tile, angle)
        found = False
